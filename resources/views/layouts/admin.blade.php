...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom" style="background-color: #347f3c !important";>
            <!-- Left navbar links -->
               ...
               <ul class="navbar-nav mx-auto">   
                  <li class='nav-item '><span class="brand-text font-weight-light"><h1>NBI PORTAL<h1></span></li>
                </ul>
            
            
             <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                  <a href="admin/users/edit/'<?php echo auth()->user()->id; ?>" class="nav-link ">
                   
                   <!-- <a class="nav-link" data-widget="pushmenu" href="#"> --><i class="fa fa-user"></i></a>
                </li>
                <li class="nav-item">
